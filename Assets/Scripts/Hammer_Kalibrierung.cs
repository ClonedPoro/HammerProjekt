...
public class Hammer_Kalibrierung : MonoBehaviour
{
    // Definitions
    float x;
    float y;
    ...
    void Start()
    {
        ...
        VP_path = Path.Combine(VP_path, "Hammer_Kalibrierung.csv");

        Debug.Log("Bitte drücke die h-Taste um den Hammer zu kalibrieren.");
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.H))
        {
            ...
            Debug.Log("DONE. Die aktuelle Hammerposition wurde eingelesen.");
        }
    }
}
